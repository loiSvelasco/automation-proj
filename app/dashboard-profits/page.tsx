  ...
  return (
    <div className={cn("flex flex-col items-center", className)}>
      <svg viewBox="0 0 200 60" className="w-full h-20">
        <polygon points="0,50 20,40 40,45 60,30 80,35 100,20 120,25 140,10 160,20 180,10 200,30 200,60 0,60" fill="#22c55e" opacity="0.15" />
        <polyline points="0,50 20,40 40,45 60,30 80,35 100,20 120,25 140,10 160,20 180,10 200,30" fill="none" stroke="#22c55e" strokeWidth="2" />
      </svg>
      ...
      <div className="flex w-full items-end justify-between h-24">
        {bars.map((h, i) => (
          <div key={i} className="flex flex-col items-center w-6">
            <div style={{ height: `${h}px` }} className="w-4 bg-green-400 rounded-t" />
          </div>
        ))}
      </div>
    ...
    <main className="flex-1 w-full max-w-7xl mx-auto px-2 sm:px-4 pb-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-8 mt-8">
        ...
        <Card className="bg-white text-gray-900 border-gray-200 flex flex-col justify-between min-h-[220px] col-span-1 shadow-sm">
          ...
          <CardContent>
            <span className="text-green-600 text-base font-semibold">+2.1% from last month</span>
