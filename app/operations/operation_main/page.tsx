...
const operationsData = [
  ...
  {
    title: "Expenses",
    description: "Track and manage all operational expenses for the business.",
    link: "/operations/expenses"
  },
  {
    title: "Employees",
    description: "Manage employee records, roles, and information.",
    link: "/operations/employees"
  },
  {
    title: "Suppliers",
    description: "View and manage supplier information and relationships.",
    link: "/operations/suppliers"
  },
  {
    title: "Deliveries",
    description: "Monitor and record all deliveries for inventory and sales.",
    link: "/operations/deliveries"
  },
  {
    title: "Returns",
    description: "Handle and track product returns efficiently.",
    link: "/operations/returns"
  },
];
...
export default function OperationsMain() {
  ...
  const totalPages = Math.ceil(operationsData.length / ITEMS_PER_PAGE);
  const startIndex = currentPage * ITEMS_PER_PAGE;
  const endIndex = startIndex + ITEMS_PER_PAGE;
  const visibleItems = operationsData.slice(startIndex, endIndex);
